...
const columns = [
  ...
  },
  {
    ...
    headerName: "دفعات فحلی طی 30 روز گذشته",
    width: 200,
  },
];
const FahliNamonazamTolidMesl = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Box>
          <Typography>فحلی نامنظم | 2 راس از 7 راس</Typography>
        </Box>
...
export default FahliNamonazamTolidMesl;
