...
const columns = [
  ...
  { field: "name", headerName: "وضعیت شیرواری", width: 120 },
  { field: "degreeShirvari", headerName: "مرتبه شیرواری", width: 110 },
  { field: "shirvariDays", headerName: "روزهای شیرواری/سن", width: 140 },
  { field: "fahliIndex", headerName: "آخرین شاخص فحلی", width: 140 },
  ...
  },
  {
    ...
    headerName: "روزهای آبستنی",
    width: 120,
  },
  { field: "propSeght", headerName: "احتمال سقط", width: 170 },
];
const MashkokSeghtTolidMesl = () => {
...
export default MashkokSeghtTolidMesl;
